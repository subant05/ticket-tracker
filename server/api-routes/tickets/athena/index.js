...
import { athenaConnect } from "../../_utils/authentication/athenaAuth.js";
import { createTicketFromAthena } from "./createTicket.js";

const router = express.Router();

router.use(athenaConnect);

router.post("/", async (req, res) => {
  try {
    const ticketData = await createTicketFromAthena(req);
